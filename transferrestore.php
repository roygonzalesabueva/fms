...
<?php
	...
	if(ISSET($_REQUEST['id'])){
		...
		$query=mysqli_query($conn, "SELECT * FROM `stored` WHERE `id`='$id'") or die(mysqli_error());
	 ...
	 mysqli_query($conn, "INSERT INTO `files` (id,name,date_updated)VALUES('$id','$name', '$date_updated')") or die(mysqli_error());
		...
		mysqli_query($conn, "DELETE FROM `stored` WHERE `id`='$id'") or die(mysqli_error());
