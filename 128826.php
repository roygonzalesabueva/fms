...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `128826` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `128826`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <a href="128826_history.php"> <i class="material-icons" style="font-size:36px;color:Blue">cloud_queue</i><font color="Black"><B>Drive</B></font></a> 
      ...
      <a href="chat_128826.php"><font color="Black"><B>Chat Room</a> | </B></font>
...
<div class="row">
         ...
         <form action="128826.php" method="post" enctype="multipart/form-data">
...
function drive(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfer128826_history.php?id=" + data_id);        
        }
    })
}
</script>
