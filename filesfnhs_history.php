...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `filesfnhs_history` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `filesfnhs_history`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      ...
      <a href="filesfnhs.php"><font color="Black"><B>Close</B></a></font>
      </div>
...
<div class="row">
         ...
         <form action="filesfnhs_history.php" method="post" enctype="multipart/form-data">
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        ...
        <a type="button" class="btn btn-success" href="transferfnhs_historydel.php?id=<?php //echo $row['id']?>">Okay</a>
    </div>
</div>
</div>
</div> -->
...
function delete_data(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferfnhs_historydel.php?id=" + data_id);        
        }
    })
}
</script>
