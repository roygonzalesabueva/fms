...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `filespnhs_history` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `filespnhs_history`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      ...
      <a href="filespnhs.php"><font color="Black"><B>Close</B></a></font>
      </div>
...
<i class="material-icons" style="font-size:48px;color:Blue">cloud_queue</i> 
<?php echo $_SESSION['school_name'];?> Drive
...
<div class="row">
         ...
         <form action="filespnhs_history.php" method="post" enctype="multipart/form-data">
...
<div class="modal-content">
    ...
    <div class="modal-footer">
        ...
        <a type="button" class="btn btn-success" href="transferpnhs_historydel.php?id=<?php echo $row['id']?>">Okay</a>
    </div>
</div>
</div>
</div> -->
...
function delete_data(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferpnhs_historydel.php?id=" + data_id);        
        }
    })
}
</script>
