...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `128818_history` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `128818_history`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      ...
      <a href="128818.php"><font color="Black"><B>Close</B></a></font>
      </div>
...
<div class="row">
         ...
         <form action="128818_history.php" method="post" enctype="multipart/form-data">
...
function delete_data(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transfer128818_historydel.php?id=" + data_id);        
        }
    })
}
</script>
