...
<button class="btn"><a href="home.php?school_id=<?php echo $schoolid ?>&emp_no=<?php echo $emp_no ?>"> <font color="white"> <i class="fa fa-close"></i>bbb </font> </a></button>
...
function upload(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferscnhs.php?school_id=<?php echo $schoolid ?>&emp_no=<?php echo $emp_no ?>" + data_id);        
        }
    })
}
</script>
