...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `filesfnhs` WHERE  CONCAT(`id`, `name`,`date_updated`)LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
    else {
        $query ="SELECT * FROM `filesfnhs`ORDER BY id DESC";
        $search_result = filterTable($query);
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <a href="filesfnhs_history.php"> <i class="material-icons" style="font-size:36px;color:Blue">cloud_queue</i><font color="Black"><B>Drive</B></font></a> 
      ...
      <a href="chat_fnhs.php"><font color="Black"><B>Chat Room</a> | </B></font>
      ...
      <a href="logout1.php"><font color="Black"><B>Home</a></B></font>
      </div>
...
<div class="row">
         ...
         <form action="filesfnhs.php" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a type="button" class="btn btn-success" href="transferfnhs_history.php?id=<?php echo $row['id']?>">Okay</a>
                </div>
            </div>
        </div>
    </div>
...
function drive(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferfnhs_history.php?id=" + data_id);        
        }
    })
}
</script>
