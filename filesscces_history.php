...
<div class="modal-content">
    ...
    <div class="modal-footer">
        ...
        <a type="button" class="btn btn-success" href="transferscces_historydel.php?id=<?php echo $row['id']?>">Okay</a>
    </div>
</div>
</div>
</div> -->
...
function delete_data(data_id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location = ("transferscces_historydel.php?id=" + data_id);        
        }
    })
}
</script>
