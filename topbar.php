...
<nav class="navbar navbar-dark bg-dark fixed-top " style="padding:0;">
  ...
  <img src="davsur2.png" width="220" height="60">
        ...
        <font color="White" size="2"><B><a <p id="demo"></p></B></font> </a>
        <a href="chat_index.php"><font color="White" size="2"><B>Chat Room</B></font></a>
  	

        <a href="#"><font color="WHITE " size="2"><B><?=$_SESSION['username']?></B></font></a>
        <a href="http://202.137.126.58/"><font color="WHITE " size="2"><B>Home</B></font></a>
